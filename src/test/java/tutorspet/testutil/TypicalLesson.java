...
public class TypicalLesson {
    ...
    public static final Lesson LESSON_WED_2_TO_4 = new LessonBuilder()
            .withStartTime(LocalTime.parse("14:00", Lesson.TIME_FORMATTER))
            .withEndTime(LocalTime.parse("16:00", Lesson.TIME_FORMATTER))
    ...
    public static final Lesson LESSON_FRI_8_TO_10 = new LessonBuilder()
            .withStartTime(LocalTime.parse("08:00", Lesson.TIME_FORMATTER))
            .withEndTime(LocalTime.parse("10:00", Lesson.TIME_FORMATTER))
    ...
    public static final Lesson LESSON_THU_10_TO_11 = new LessonBuilder()
            .withStartTime(LocalTime.parse("10:00", Lesson.TIME_FORMATTER))
            .withEndTime(LocalTime.parse("11:00", Lesson.TIME_FORMATTER))
    ...
    public static final Lesson ONLINE_LESSON_TUE_1030_1130 = new LessonBuilder()
            .withStartTime(LocalTime.parse("10:30", Lesson.TIME_FORMATTER))
            .withEndTime(LocalTime.parse("11:30", Lesson.TIME_FORMATTER))
