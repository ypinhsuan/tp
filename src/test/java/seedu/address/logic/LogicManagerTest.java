...
import seedu.address.storage.JsonTutorsPetStorage;
...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonTutorsPetStorage addressBookStorage =
                new JsonTutorsPetStorage(temporaryFolder.resolve("addressBook.json"));
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        ...
        JsonTutorsPetStorage addressBookStorage =
                new JsonTutorsPetIoExceptionThrowingStub(temporaryFolder.resolve("ioExceptionAddressBook.json"));
