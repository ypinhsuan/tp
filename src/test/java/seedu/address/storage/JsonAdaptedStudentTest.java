...
public class JsonAdaptedStudentTest {
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedStudent student =
                new JsonAdaptedStudent(VALID_UUID, null, VALID_PHONE, VALID_EMAIL, VALID_TAGS);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedStudent student =
                new JsonAdaptedStudent(VALID_UUID, VALID_NAME, INVALID_PHONE, VALID_EMAIL, VALID_TAGS);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedStudent student =
                new JsonAdaptedStudent(VALID_UUID, VALID_NAME, VALID_PHONE, INVALID_EMAIL, VALID_TAGS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedStudent student =
                new JsonAdaptedStudent(VALID_UUID, VALID_NAME, VALID_PHONE, null, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedStudent student =
                new JsonAdaptedStudent(VALID_UUID, VALID_NAME, VALID_PHONE, VALID_EMAIL, invalidTags);
